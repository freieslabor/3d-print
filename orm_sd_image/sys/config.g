...
; 
M111 S0                             ; Debug off
M550 POrmerod                       ; Machine name (can be anything you like). With DHCP enabled connect to (example) http://reprapproormerod1 (machine name with no spaces).
...
G31 Z2.0 P600                       ; Set the probe height and threshold
;G31 Z1.6 P666                       ; Set the probe height and threshold
